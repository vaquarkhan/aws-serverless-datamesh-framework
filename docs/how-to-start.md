...
| **You get** | Durable Lambda, 15–90 min segments (on-demand or LMI), IceGuard + durable budget (any wall-clock) |
| **Benefit** | Longer jobs without idle EMR/Glue; incomplete writes never corrupt Iceberg |
